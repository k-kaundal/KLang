...
typedef enum {
    ...
    TOKEN_CLASS, TOKEN_NEW, TOKEN_THIS, TOKEN_EXTENDS, TOKEN_SUPER, TOKEN_STATIC, TOKEN_CONSTRUCTOR,
    ...
    TOKEN_STRUCT, TOKEN_UNION, TOKEN_TYPEDEF,
    TOKEN_UNSAFE,  /* Security: marks unsafe blocks */
