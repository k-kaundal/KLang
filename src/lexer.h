...
typedef enum {
    ...
    TOKEN_RETURN, TOKEN_BREAK, TOKEN_CONTINUE, TOKEN_IN, TOKEN_TRUE, TOKEN_FALSE,
    TOKEN_CLASS, TOKEN_NEW, TOKEN_THIS, TOKEN_EXTENDS, TOKEN_SUPER,
    ...
    TOKEN_COLON, TOKEN_SEMICOLON, TOKEN_COMMA, TOKEN_ARROW, TOKEN_DOTDOT, TOKEN_DOT,
    TOKEN_EOF
} TokenType;
